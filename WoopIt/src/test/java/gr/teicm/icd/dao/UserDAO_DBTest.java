...
public class UserDAO_DBTest extends DatabaseTestCase {
	...
	public void testIsFriend() throws SQLException {
		...
		isFriend = userDaoTest.isFriendTest(currentUser, targetUser);
		assertTrue(isFriend);
	}
	...
	public void testIsBlocked() throws SQLException {
		...
		isBlocked = userDaoTest.isBlockedTest(currentUser, targetUser);
	...
	public void testGetAllFriends() throws SQLException {
		...
		allFriends = userDaoTest.getAllFriendsTest(currentUser);
	...
	public void testGetAllBlocked() throws SQLException {
		...
		allBlocked = userDaoTest.getAllBlockedTest(currentUser);
