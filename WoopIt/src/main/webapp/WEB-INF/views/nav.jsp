	    	...
	    	<ul class="nav navbar-nav navbar-right">
		        ...
		        <li class="dropdown">
		          ...
		          <ul class="dropdown-menu">
		            ...
		            <li><a href="<c:url value='/viewprofile?name=${currentUser.userName}&friend=false&blocked=false' />"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;&nbsp;Profile</a></li>
