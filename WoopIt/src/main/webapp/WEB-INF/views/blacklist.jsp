	...
	<div id="intro">
		<div class="container">
			<div class="row centered">
				<h1><span class="glyphicon glyphicon-ban-circle" aria-hidden="true"></span>&nbsp;&nbsp;Your Black List</h1>
				<hr>
				<br>
				<div class="col-lg-4">
				</div>
				<div class="col-lg-6">
				<c:forEach items="${allBlocked}" var="blocked">
						<div class="well well-sm">
							<div class="media">
							  ...
							  <c:if test="${url=='/WoopIt/WEB-INF/views/viewprofile.jsp'}">class="active"</c:if>
							  	<a href="<c:url value='/viewprofile?name=${blocked.userName}&friend=false&blocked=false' />"><c:out value="${blocked.userName}"/></a><br/>
							  </div>
							</div>
						</div>
				</c:forEach>
