...
<html lang="en">
  <head>
    ...
    <title>WoopIt - Access denied</title>
		...
		<div class="container">
			<div class="row centered">
				...
				<div class="alert alert-danger" role="alert">
					...
					<br/>
					Please use the <a href="<c:url value='/user/login' />">sign in</a> or <a href="<c:url value='/user/register' />">sign up</a> form if you don't have already an account.
				</div>
