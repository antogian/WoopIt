...
<head>
	...
	<title>WoopIt - Edit Profile</title>
	...
	<div id="intro">
		<div class="container">
			<div class="row centered">
				<h1><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;&nbsp;Edit your profile</h1>
				<hr>
				<br>
				<div class="col-lg-4">
				</div>
				<div class="col-lg-6">
					<c:url var="editprofileUrl" value="/user/editprofile" />
					<form class="form-horizontal" action="${editprofileUrl}" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="email" class="form-control" id="userEmail" name="userEmail" placeholder="${userEmail}" required />
							</div>
						</div>
						<div class="form-group">
